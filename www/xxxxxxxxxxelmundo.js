...
// -------------------------------------------------------------------------------------------------------------------
// funcion update lista, se ejecuta cada pocos segundos. MIS SUBASTAS
// -------------------------------------------------------------------------------------------------------------------
...
function update_lista()
{
			...
			$.each(mensaje.lista, function(ID, data) {
				...
				switch (Number(data.Status)) {
					case 0: // Agotado, finalizado
						...
						newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'><div id='time_"+data.Id+"'></div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"'></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+" &euro;</td>";

						newRow = newRow + '<td><div class="grupbtns" id="capabotons"><button type="button" class="btn btn-danger" id="ocultar_'+data.Id+'"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button></div></td></tr>'; // Todos los botones desactivados
						break;
					...
					case 3: // Lliberada
						...
						newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'>"+Estat+"<div id='time_"+data.Id+"'></div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"'></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+" &euro;</td>";

						newRow = newRow + '<td><div class="grupbtns" id="capabotons_'+data.Id+'"><button type="button" class="btn btn-success" id="editar_'+data.Id+'"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i></button><button type="button" class="btn btn-danger" id="cancelar_'+data.Id+'"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button></div></td></tr>';
						break;

					case 5: // Asignada
						Estat = 'Asignada';

						newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'>" + Estat + "<input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"'></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+" &euro;</td>";

						newRow = newRow + '<td><div class="grupbtns" id="capabotons_'+data.Id+'"><button type="button" class="btn btn-danger" id="cancelar_'+data.Id+'"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button></div></td></tr>';
						break;
					...
					case 91: // Cancelada por el cliente
						...
						newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'><div id='time_"+data.Id+"'>" + Txt +"</div></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+" &euro;</td>";
					...
					default: // Otro Estado
						var Txt = "Estado no definido correctamente. Estado " + data.Status;
			...
			$.each(mensaje.lista, function(ID, data) {
				...
				if (data.Status == 1 || data.Status==2 || data.Status ==3) {
					...
					$(nom).click(function () {
						...
						window.location.href = 'paso4.html?update='+data.Id;
					});
				}
	...
	//					if (confirmar) {
							var url = "http://elmundo.webexpo.es/subastas.php";
							url = url + "?usuario=" + datosUsuario + "&password=" + datosPassword + "&idsubasta="+ data.Id +"&accion=valorarporusuario";
							$.getJSON(url,function(mensaje, validacion) {
								if (validacion == 'success') {
	//								alert ('La oferta ha sido cancelada');
									window.location.href = 'mis_subastas.html';
								} else {
									alert ('Ha habido algun problema para valorar esta oferta. El motivo es : ' + html_entity_decode(mensaje.mensaje, 'ENT_QUOTES'));
								}
							});
	//					}
					});
				...
				if (data.Status == 0 || data.Status == 18  || data.Status == 90 || data.Status == 91) {
				...
				if (mensaje.lista === null)
					...
					$.each(mensaje.lista, function(ID, data) {
						...
						switch (Number(data.Status)) {
							case 0: // Agotado, finalizado
									...
									newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'><div id='time_"+data.Id+"'></div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"'></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/>"+data.Description+"</td><td>"+data.Price+" &euro;</td></tr>";
							...
							case 3: // Lliberada
									...
									newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'>"+Estat+"<div id='time_"+data.Id+"'></div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"'></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/>"+data.Description+"</td><td>"+data.Price+" &euro;</td></tr>";
									newRow = newRow + '<tr><td class="text-left" colspan="4"><div class="grupbtns" id="capabotons_'+data.Id+'"></div></td></tr>';
							...
							case 5: // Asignada para mi
									if (soyyo) {
										var Txt = "Aceptada por mí";
									} else {
										var Txt = "Aceptada por otro asociado";
									}

									newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.CreationDate+"</strong></td><td class='videfech'><div id='time_"+data.Id+"'>" + Txt +"</div></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/>"+data.Description+"</td><td>"+data.Price+" &euro;</td></tr>";
							...
							case 10: // Completada
									...
									if (soyyo) {
										newRow = newRow + '<tr><td class="text-left" colspan="4"><div class="grupbtns" id="capabotons_'+data.Id+'"><button type="button" class="btn btn-info" id="verdatos_'+data.Id+'"><i class="fa fa-users fa-2x" aria-hidden="true"></i></button><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal3" id="valorar_'+data.Id+'"><i class="fa fa-star-o fa-2x" aria-hidden="true"></i></button><button type="button" class="btn btn-danger" id="borrar_'+data.Id+'"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button></div></td></tr>'; 
									} else {
										newRow = newRow + '<tr><td class="text-left" colspan="4"></td></tr>'; // Todos los botones desactivados
									}
									break;
							...
							case 18: // Cancelada por el associado
									if (soyyo) {
										var Txt = "Cancelada por mí";
									} else {
										var Txt = "Cancelada por otro asociado";
									}
							...
							case 30: // Valorada por el asociado
									if (soyyo) {
										var Txt = "Valorada por mí y por el cliente";
									} else {
										var Txt = "Cerrada";
									}
							...
							case 90: // Cancelada por el cliente
									var Txt = "Cancelada recientemente por el usuario";
					...
					$.each(mensaje.lista, function(ID, data) {
						...
						if ((data.Status ==10 || data.Status ==20 ) && soyyo) {
							...
							$(nom2).click(function () {
								var url = "http://elmundo.webexpo.es/subastas.php";
								url = url + "?usuario=" + datosUsuario + "&password=" + datosPassword + "&idsubasta="+ data.Id +"&accion=valorar";
								$.getJSON(url,function(mensaje, validacion) {
									if (validacion == 'success') {
										alert ('Has confirmado la valoración de la venta.');
										window.location.href = 'subastas_asociados.html';
									} else {
										alert ('Ha habido algun problema para valorar la venta. El motivo es : ' + html_entity_decode(mensaje.mensaje, 'ENT_QUOTES'));
									}
								});
							});
						}
					...
					$.each(mensaje.lista, function(ID, data) {
						...
						switch (Number(data.Status)) {
							...
							case 98:
									...
									newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.ConfirmationDate+"</strong></td><td ></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+" &euro;</td>";

									newRow = newRow + '<td><div class="grupbtns" id="capabotons_'+data.Id+'"><button type="button" class="btn btn-info" id="verdatos_'+data.Id+'"><i class="fa fa-users fa-2x" aria-hidden="true"></i></button></div></td></tr>'; 
									break;
						}
