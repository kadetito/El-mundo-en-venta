					...
					$.each(mensaje.lista, function(ID, data) {
						...
						switch (Number(data.Status)) {
							...
							case 98:
									...
									newRow = newRow + "<tr class='success'><td class='videfech text-center'><strong>"+data.ConfirmationDate+"</strong></td><td><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td><td>"+data.Description+"</td><td>"+data.Price+"&nbsp;&euro;</td>";
