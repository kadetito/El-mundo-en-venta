...
//002 modificado
newRow = newRow + "<tr><td rowspan='3' width='30%'>"+Estat+"<div id='time_"+data.Id+"' style='color:"+color+"'>"+TxtRemainTime+"</div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'><div class='grupbtns' id='capabotons' style='display:"+ TxtDisplay +"'></div><div class='grupbtns'><div class='grupbtns' id='capabotons_"+data.Id+"'></div></div></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
...
//006
newRow = newRow + "<tr><td rowspan='3' width='30%'>" + Estat + "<input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%' class='success'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'><div class='grupbtns' id='capabotons_"+data.Id+"'></div></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
...
//010						
newRow = newRow + "<tr><td rowspan='3' width='30%'>" + Estat + "</td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
...
//011
newRow = newRow + "<tr><td rowspan='3' width='30%'><div id='time_"+data.Id+"' style='color:"+color+"'>"+TxtRemainTime+"</div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'><div class='grupbtns' id='capabotons_"+data.Id+"' style='display:"+ TxtDisplay +"'></div></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
...
//012																		
newRow = newRow + "<tr><td rowspan='3' width='30%'>"+Estat+"<div id='time_"+data.Id+"' style='color:"+color+"'>"+TxtRemainTime+"</div><input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'><div class='grupbtns' id='capabotons_"+data.Id+"' style='display:"+ TxtDisplay +"'><button type='button' class='btn btn-success' id='aceptar_"+data.Id+"'><i class='fa fa-check-square fa-2x' aria-hidden='true'></i></button></div></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
...
//013									
newRow = newRow + "<tr><td rowspan='3' width='30%'>" + Estat + "<input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
											
									if (soyyo) {
//014
newRow = newRow + "<tr><td rowspan='3' ><div class='grupbtns' id='capabotons_"+data.Id+"'><button type='button' class='btn btn-info' id='verdatos_"+data.Id+"'><i class='fa fa-users fa-2x' aria-hidden='true'></i></button><button type='button' class='btn btn-success' id='confirmar_"+data.Id+"'><i class='fa fa-check-square fa-2x' aria-hidden='true'></i></button><button type='button' class='btn btn-warning' id='liberar_"+data.Id+"'><i class='fa fa-undo fa-2x' aria-hidden='true'></i></button></div></td></tr>";
									
									
									} else {
//015
newRow = newRow + '<tr><td rowspan="3"></td></tr>'; // Todos los botones desactivados
									}
									break;
...
newRow = newRow + "<tr><td rowspan='3' width='30%'>" + Estat + "<input class='cronos' type='hidden' name='limit_"+data.Id+"' value='"+data.RemainTime+"' estado='"+data.Status+"'></td><td width='27%'>"+data.CreationDate+"</td><td width='34%'><strong>"+data.Price+"&nbsp;&euro;</strong></td><td rowspan='3' width='9%'><div class='grupbtns' id='capabotons_"+data.Id+"'><button type='button' class='btn btn-info' id='verdatos_"+data.Id+"'><i class='fa fa-users fa-2x' aria-hidden='true'></i></button></div></td></tr><tr><td colspan='2'><img src='"+img+"' id='image_"+data.Id+"' class='thumb'/></td></tr><tr><td colspan='2' class='descrclass'>"+data.Description+"</td></tr>";
	...
	$.getJSON(url,function(mensaje, validacion) {
		...
		if (mensaje.lista === null)
			...
			$.each(mensaje.lista, function(ID, data) {
				...
				newRow = newRow + "<tr class='success'><td class='videfech text-center'>"+data.fecha+"</td><td>"+data.numero+"</td><td><a href='"+data.link+"' class='enlacefacturas'>aqu&iacute;</a></td></tr>"; 
