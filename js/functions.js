...
//--------------------------------------------------------------------------------------------
//Primjeri hover functions
//-------------------------------------------------------------------------------------------- 
	$("#Primjeri li.thumb").hover(function() {
...
(function($) {
	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			//Create caption
			slider.append(
				$('<div class="nivo-caption"><p><span></span></p></div>').css({ display:'none', opacity:settings.captionOpacity })
			);			
			//Process initial  caption
			if(vars.currentImage.attr('title') != ''){
				$('.nivo-caption p span', slider).html(vars.currentImage.attr('title'));					
		...
		function nivoRun(slider, kids, settings, nudge){
			...
			if(vars.currentImage.attr('title') != ''){
				if($('.nivo-caption', slider).css('display') == 'block'){
					$('.nivo-caption p span', slider).fadeOut(settings.animSpeed, function(){
